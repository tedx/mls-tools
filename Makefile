...
pkgdatadir = $(datadir)/mls-tools
pkgincludedir = $(includedir)/mls-tools
pkglibdir = $(libdir)/mls-tools
pkglibexecdir = $(libexecdir)/mls-tools
...
CYGPATH_W = echo
DATADIRNAME = share
DEFS = -DPACKAGE_NAME=\"mls-tools\" -DPACKAGE_TARNAME=\"mls-tools\" -DPACKAGE_VERSION=\"0.0.1\" -DPACKAGE_STRING=\"mls-tools\ 0.0.1\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE=\"mls-tools\" -DVERSION=\"0.0.1\" -DGETTEXT_PACKAGE=\"mls-tools\" -DSTDC_HEADERS=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGS_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_UNISTD_H=1 -DHAVE_LOCALE_H=1 -DHAVE_LC_MESSAGES=1 -DHAVE_BIND_TEXTDOMAIN_CODESET=1 -DHAVE_GETTEXT=1 -DHAVE_DCGETTEXT=1 -DENABLE_NLS=1
DEPDIR = .deps
ECHO_C = 
ECHO_N = -n
ECHO_T = 
EGREP = /bin/grep -E
EXEEXT = 
GETTEXT_PACKAGE = mls-tools
GMOFILES =  en.gmo ja.gmo ko.gmo
...
PACKAGE = mls-tools
PACKAGE_BUGREPORT = 
PACKAGE_NAME = mls-tools
PACKAGE_STRING = mls-tools 0.0.1
PACKAGE_TARNAME = mls-tools
PACKAGE_VERSION = 0.0.1
PATH_SEPARATOR = :
POFILES =  en.po ja.po ko.po
POSUB = po
PO_IN_DATADIR_FALSE = 
PO_IN_DATADIR_TRUE = 
...
pdfdir = ${docdir}
pkgpyexecdir = ${pyexecdir}/mls-tools
pkgpythondir = ${pythondir}/mls-tools
prefix = /usr/local
